<template>
  <div class="settings-view">
    ...
    <!-- ===== CẤU HÌNH TRANG GIỚI THIỆU (ABOUT) ===== -->
    <div class="section-card">
      <div class="card-head">
      ...
      <div class="form-grid">
        <div class="form-group" style="grid-column: 1/-1;">
          <label>Tiêu đề lớn Hero:</label>
          <input v-model="settings.aboutHeroTitle" class="form-input" placeholder="Lan tỏa tri thức, Kết nối đam mê" />
        </div>
        <div class="form-group" style="grid-column: 1/-1;">
          <label>Mô tả Hero:</label>
          <RichTextEditor v-model="settings.aboutHeroSubtitle" placeholder="LibManage không chỉ là một hệ thống quản lý thư viện..." />
        </div>

        <div class="form-group">
          <label>Nhãn sứ mệnh (Badge):</label>
          <input v-model="settings.aboutMissionBadge" class="form-input" placeholder="Sứ mệnh của chúng tôi" />
        </div>
        <div class="form-group">
          <label>Tiêu đề Sứ mệnh:</label>
          <input v-model="settings.aboutMissionTitle" class="form-input" placeholder="Xây dựng nền tảng tri thức vững chắc cho tương lai" />
        </div>

        <div class="form-group" style="grid-column: 1/-1;">
          <label>Nội dung Sứ mệnh - Đoạn 1:</label>
          <RichTextEditor v-model="settings.aboutMissionDesc1" placeholder="Được thành lập từ năm 2010..." />
        </div>
        <div class="form-group" style="grid-column: 1/-1;">
          <label>Nội dung Sứ mệnh - Đoạn 2:</label>
          <RichTextEditor v-model="settings.aboutMissionDesc2" placeholder="Với hệ thống quản lý điện tử LibManage..." />
        </div>

        <div class="form-group" style="grid-column: 1/-1;">
          <label>Đường dẫn hình ảnh giới thiệu:</label>
          <div style="display: flex; gap: 10px;">
            <input v-model="settings.aboutMissionImage" class="form-input" style="flex: 1;" placeholder="https://images.unsplash.com/..." />
          ...
          <div v-if="settings.aboutMissionImage" style="margin-top: 10px; max-width: 240px; border-radius: 8px; overflow: hidden; border: 1px solid rgba(255,255,255,0.1);">
            <img :src="settings.aboutMissionImage" alt="Giới thiệu" style="width: 100%; display: block;" />
          </div>
        </div>
      </div>
    ...
    <!-- ===== CẤU HÌNH TRANG HƯỚNG DẪN MƯỢN SÁCH ===== -->
    <div class="section-card">
      <div class="card-head">
    ...
    <!-- ===== CẤU HÌNH TRANG CÂU HỎI THƯỜNG GẶP (FAQS) ===== -->
    <div class="section-card">
      <div class="card-head">
